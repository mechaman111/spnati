...
var CANDY_LIST = [
    ...
    "rosa/0-portrait.png",             // Highlighted New Character
    "rosa/0-horny.png",
    "rosa/2-embarrassed.png",
    "rosa/1-thinking.png",
    "barbara/0-cheering.png",          // Highlighted New Character
    "barbara/0-surprised.png",
    "barbara/0-sheepish.png",
    "barbara/0-happy.png",
    "noire/0-niya.png",                // Highlighted New Character
    "noire/0-smug.png",
    "noire/0-teasing.png",
    "noire/0-thinking.png",
    "kyou/0-calm.png",                 // Highlighted New Character
    "kyou/0-sarcastic.png",
    "kyou/2-shy.png",
    "kyou/2-smug.png",
    "zoe/0-happy.png",                 // Highlighted New Character
    "zoe/0-blush.png",
    "zoe/0-fangirling.png",
    "zoe/0-smug.png",
    "hatsune_miku/0-Casual.png",       // Highlighted New Character
    "hatsune_miku/0-Cheeky.png",
    "hatsune_miku/0-Encouraging.png",
    "hatsune_miku/0-Excited.png",
    "gwen/0-calm.png",                 // Highlighted New Character
    "gwen/2-happy.png",
    "gwen/2-horny.png",
    "gwen/2-cocky.png",
    "nugi-chan/0-loss.png",            // Has Recent Updates
    "nugi-chan/0-awkward.png",
    "nugi-chan/0-shylookdown.png",
    "nugi-chan/0-happy.png",
    ...
    "rin/0-absent.png",                // Has Recent Updates
    "rin/0-curious.png",
    "rin/1-sleepy.png",
    "rin/1-DPAmused.png",
    ...
    "rouge/0-comms.png",
    "rouge/0-flirty.png",
    "syrenne/0-cheers.png",            // Has Recent Updates
    "syrenne/0-confident.png",
    "syrenne/3-flustered.png",
    "syrenne/3-yell.png",
    ...
    "kazuma/3-smirk.png",
    "shimakaze/0-ganbatte.png",        // Has Recent Updates
    "shimakaze/1-calling.png",
    "shimakaze/2-stumped.png",
    "shimakaze/3-determined.png",
    "sheena/0-calm.png",               // Has Recent Updates
    "sheena/1-ironic.png",
    "sheena/2-victory.png",
    "sheena/3-removed.png",
    ...
    "petra/0-stretch.png",
    "petra/0-horny.png",
    "erufuda/0-eating.png",            // Has Recent Updates
    "erufuda/1-concerned.png",
    "erufuda/1-smug.png",
    "erufuda/2-taunting.png",
    ...
    "mercy/3-horny.png",
    "shantae/0-calm.png",              // Has Recent Updates
    "shantae/0-playful.png",
    "shantae/0-happy.png",
    "shantae/0-intro.png",
    ...
    "emi/1-excited.png",               // Has Recent Updates
    "emi/1-laughing.png",
    "emi/2-excited.png",
    ...
    "pa-15/0-portrait.png",            // Has Recent Updates
    "pa-15/0-inviting.png",
    "pa-15/0-bliss.png",
    "pa-15/0-satisfied.png",
    ...
    "brock/0-calm.png",                // Has Recent Updates
    "brock/0-cheering.png",
    "brock/3-laughing.png",
    "brock/3-cool.png",
    ...
    "rainbow_dash/0-smug.png",         // Has Recent Updates
    "rainbow_dash/0-laughing.png",
    "rainbow_dash/0-mybad.png",
    "rainbow_dash/0-stretch.png",
    "twilight/0-calm.png",             // Has Recent Updates
    ...
    "stocking/0-hex.png",
    "stocking/0-smug.png",
    "rarity_eg/0-start.png",           // Has Recent Updates
    "rarity_eg/0-acreative.png",
    "rarity_eg/0-bdefault.png",
    "rarity_eg/0-claughing.png",
