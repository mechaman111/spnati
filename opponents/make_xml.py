...
def write_xml(data, filename):
	...
	o.append(Comment("This file was machine generated by make_xml.py version 2.1.1 in " + mydate.strftime("%B") + " " + mydate.strftime("%Y") +". Please discontinue use of this tool, as it has been replaced by the Character Editor."))
