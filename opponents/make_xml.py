...
multi_word_targets = ["targetStage", "alsoPlaying", "alsoPlayingStage", "alsoPlayingHand", "oppHand", "hasHand", "totalMales", "totalFemales", "timeInStage", "alsoPlayingTimeInStage", "ownTimeInStage", "consecutiveLosses", "totalAlive", "totalExposed", "totalNaked", "totalFinishing", "totalFinished"] #these will need to be re-capitalised when writing the xml
