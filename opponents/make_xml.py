...
replacements = {'&lt;i&gt;':'<i>', '&lt;/i&gt;':'</i>', '&amp;':'&'} #By only converting angled brackets when they're part of italics, characters like Nugi-chan can still used them as displayed characters without creating invalid xmls.
