if (!pog) var pog = (function (root) {
	...
	var SIX_FLUSH = 6.6;
	var SEVEN_STRAIGHT = 7.5;
	var SEVEN_FLUSH = 7.6;
	var STRAIGHT_PLUS_PAIR = 7.7;
	var FULL_HOUSE_PLUS_PAIR = 8.5;
	var TWO_THREE_OF_A_KINDS = 8.6;
	var FULLER_HOUSE = 8.7;
	var FULLEST_HOUSE = 9.5;
	var STRAIGHT_FLUSH_PLUS_PAIR = 9.6;
	var SIX_STRAIGHT_FLUSH = 9.7;
