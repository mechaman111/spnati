namespace SPNATI_Character_Editor.Forms
{
	partial class CanvasHelp
	{
		...
		private void InitializeComponent()
		{
			...
			this.label4.Text = "Ctrl + mouse wheel";
			// 
			// label3
			// 
			...
			this.label2.Text = "Right click + drag";
			// 
			// label1
			// 
			...
			this.label13.Text = "Shift + left click + drag object edge";
			// 
			// label14
			// 
			...
			this.label12.Text = "Left click + drag dot inside object";
			// 
			// label11
			// 
			...
			this.label9.Text = "Left click + drag outside object corner";
			// 
			// label10
			// 
			...
			this.label5.Text = "Left click + drag object corner or edge";
			// 
			// label6
			// 
			...
			this.label7.Text = "Left click + drag inside object";
			// 
			// label8
			// 
