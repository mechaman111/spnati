...
namespace SPNATI_Character_Editor
{
	...
	public class Case : IComparable<Case>
	{
		...
		[Expression(DisplayName = "Variable Test (+)", GroupName = "Game", GroupOrder = 5, Description = "Tests the value of a variable. Multiple can be added", BoundProperties = new string[] { "Target" })]
		[XmlElement("test")]
