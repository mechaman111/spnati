...
namespace SPNATI_Character_Editor
{
	public class Scene : ICloneable
	{
		...
		[ComboBox(DisplayName = "Effect", Key = "effect", GroupOrder = 0, Description = "Visual transition effect between scenes", Options = new string[] { "dissolve", "fade", "wipe-right", "wipe-left", "wipe-up", "wipe-down" })]
		[XmlAttribute("effect")]
