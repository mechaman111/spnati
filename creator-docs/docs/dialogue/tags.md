...
|`fairy`|`supernatural`| The character is a fairy or sprite-like, with wings and various magical powers.
...
|`wand`|`weapon`| A rod, staff, or other magical implement E.g. Hermione, Dark Magician Girl
...
|`no_underwear`| | The character does not wear underwear under their major item. 
...
|Tag Name|Supertag|Description
|--------|--------|-----------
|`bondage_forfeit`| | The character is restrained during forfeit, e.g. Scarlet Witch, Vriska 
